# HMS Elite — Paquete de Documentacion de Negocio y Operacion

Este bloque ordena la documentacion que hace falta para vender, implementar y operar HMS Elite con criterio serio.
...
- [economic-proposal-example.md](economic-proposal-example.md)
...
- [templates/client-implementation-log-template.md](templates/client-implementation-log-template.md)
...
- workflows canonicos por usuario: [user-workflows-v1.md](../ops/user-workflows-v1.md)
