...
decisiones estructurales y su contexto/tradeoffs.
...
| [ADR-0007](./ADR-0007-mobile-composition.md) | Mobile task composition | Composición responsive y flujos operativos móviles |
